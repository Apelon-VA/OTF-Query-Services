...
@BdbTestRunnerConfig()
public class TempQueryTest extends JerseyTest {
    
    public TempQueryTest() {
    }
...
//    }
    ...
    public void testQuery() {
        try {
            TempExampleQueryTest q = new TempExampleQueryTest(null);
...
"</view-coordinate>";
            ...
            Logger.getLogger(TempQueryTest.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
