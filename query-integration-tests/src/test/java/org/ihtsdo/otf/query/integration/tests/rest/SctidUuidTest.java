...
public class SctidUuidTest extends JerseyTest {
    ...
    public void runUuidTest() {
        String resultString = target("query-service/uuid/285649006").
    ...
    public void runSctidTest() {
        String resultString = target("query-service/sctid/2b684fe1-8baf-34ef-9d2a-df03142c915a").
                request(MediaType.TEXT_PLAIN).get(String.class);
    ...
    public void runNullSctidTest() {
        String resultString = target("query-service/sctid").request(MediaType.TEXT_PLAIN).get(String.class);
        assertEquals("Add the UUID to the end of the URL", resultString);
    }

    @Test
    public void runNullUUIDTest() {
        String resultString = target("query-service/uuid").request(MediaType.TEXT_PLAIN).get(String.class);
